            ...
            <div className="card bg-base-100 shadow-xl border-2">
                ...
                <div className="flex flex-grow card-body">
                    ...
                    <div className='flex justify-between gap-3'>
                        ...
                        <Link to='/update-assignment/:id' className='hover:bg-green-600 hover:text-white bg-white text-red-600 border-2 px-2 flex  items-center gap-2 font-bold text-xs'><FaRegEdit className='text-lg'></FaRegEdit>Update</Link>
